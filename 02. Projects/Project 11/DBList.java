 ...
 */   
  ...
  /////METHODS/////
    ...
    * @throws InvalidCategoryException shown if default is reached. 
    */
   ...
   /** 
    * Method for generating MonthlyReport sorted by cost. 
    * @return output returns output. */
   ...
   /**
    * Method for generating Invalid Record Report sorted.
    * @return output returns output. */
